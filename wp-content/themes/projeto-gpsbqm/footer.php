<footer>
    <div class="footer-left">
        ...
        <span>© copyright by abeazist from GitHub</span>
      </div>
      <div class="footer-right">
        <a href="*" target="_blank">
          <img class="imgfooter" src="http://localhost/projeto-estagio2024-novo/wp-content/uploads/2025/01/youtube.png" alt="YouTube Logo" class="icon">
        </a>
        <a href="*" target="_blank">
